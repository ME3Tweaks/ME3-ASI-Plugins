...
{
	struct FString                                     SublevelName;                                     		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     ObjectName;                                       		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     Value;                                            		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UClass*                                      ObjectClass;                                      		// 0x0024 (0x0004) [0x0000000000000000]              
	struct FName                                       PropertyName;                                     		// 0x0028 (0x0008) [0x0000000000000000]              
};
...
struct FAccomplishment
{
	...
	struct FName                                       ChallengeGroupName;                               		// 0x001C (0x0008) [0x0000000000000000]              
	struct FName                                       GrinderAccomplishmentName;                        		// 0x0024 (0x0008) [0x0000000000000000]              
	int                                                Index;                                            		// 0x002C (0x0004) [0x0000000000000000]              
	int                                                XboxAchievementID;                                		// 0x0030 (0x0004) [0x0000000000000000]              
	int                                                XboxAvatarAwardID;                                		// 0x0034 (0x0004) [0x0000000000000000]              
	int                                                PS3TrophyID;                                      		// 0x0038 (0x0004) [0x0000000000000000]              
	void*                                              Title;                                            		// 0x003C (0x0004) [0x0000000000000000]              
	void*                                              Incomplete;                                       		// 0x0040 (0x0004) [0x0000000000000000]              
	void*                                              Complete;                                         		// 0x0044 (0x0004) [0x0000000000000000]              
	int                                                PointValue;                                       		// 0x0048 (0x0004) [0x0000000000000000]              
	void*                                              NotificationText;                                 		// 0x004C (0x0004) [0x0000000000000000]              
	void*                                              MPNotificationText;                               		// 0x0050 (0x0004) [0x0000000000000000]              
	int                                                VisibilityStartTime;                              		// 0x0054 (0x0004) [0x0000000000000000]              
	int                                                VisibilityEndTime;                                		// 0x0058 (0x0004) [0x0000000000000000]              
	unsigned long                                      IsMultiplayerOnly : 1;                            		// 0x005C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bRepeatableChallenge : 1;                         		// 0x005C (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned char                                      LinkedAchievementID;                              		// 0x0060 (0x0001) [0x0000000000000000]              
};
...
struct FDeathInfo
{
	...
	unsigned long                                      bHeadShot : 1;                                    		// 0x000C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bHeadGib : 1;                                     		// 0x000C (0x0004) [0x0000000000000000] [0x00000002] 
};
...
{
	struct FString                                     PlayerVariableGranted;                            		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FName                                       Name;                                             		// 0x000C (0x0008) [0x0000000000000000]              
	struct FName                                       AccomplishmentName;                               		// 0x0014 (0x0008) [0x0000000000000000]              
	int                                                EntitlementIDGranted;                             		// 0x001C (0x0004) [0x0000000000000000]              
	int                                                RewardIDGranted;                                  		// 0x0020 (0x0004) [0x0000000000000000]              
	unsigned long                                      bUseNucleusCheck : 1;                             		// 0x0024 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	struct FString                                     PlayerKit;                                        		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     PlayerClass;                                      		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     MapName;                                          		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< int >                                      RequiredPlayerMedals;                             		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< int >                                      PartialPlayerMedals;                              		// 0x0030 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< int >                                      RequiredSquadMedals;                              		// 0x003C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< int >                                      PartialSquadMedals;                               		// 0x0048 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FName                                       AccomplishmentProgressName;                       		// 0x0054 (0x0008) [0x0000000000000000]              
	struct FName                                       KilledEnemyClass;                                 		// 0x005C (0x0008) [0x0000000000000000]              
	struct FName                                       ChallengeDamageType;                              		// 0x0064 (0x0008) [0x0000000000000000]              
	struct FName                                       PowerName;                                        		// 0x006C (0x0008) [0x0000000000000000]              
	int                                                EventStartTime;                                   		// 0x0074 (0x0004) [0x0000000000000000]              
	int                                                EventEndTime;                                     		// 0x0078 (0x0004) [0x0000000000000000]              
	void*                                              DamageSource;                                     		// 0x007C (0x0004) [0x0000000000000000]              
	int                                                DifficultyLevel;                                  		// 0x0080 (0x0004) [0x0000000000000000]              
	int                                                EnemyType;                                        		// 0x0084 (0x0004) [0x0000000000000000]              
	int                                                NumPlayers;                                       		// 0x0088 (0x0004) [0x0000000000000000]              
	unsigned long                                      bMelee : 1;                                       		// 0x008C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bHeadShot : 1;                                    		// 0x008C (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bHeadGib : 1;                                     		// 0x008C (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bCombo : 1;                                       		// 0x008C (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bBiotic : 1;                                      		// 0x008C (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bTech : 1;                                        		// 0x008C (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned char                                      ChallengeType;                                    		// 0x0090 (0x0001) [0x0000000000000000]              
	unsigned char                                      MedalEarned;                                      		// 0x0091 (0x0001) [0x0000000000000000]              
};
...
struct FPlayerChallengeScoreData
{
	...
	void*                                              LastDamageSource;                                 		// 0x0014 (0x0004) [0x0000000000000000]              
};
...
struct Asfxpawn_FScoreEvent
{
	...
	void*                                              SourceName;                                       		// 0x0008 (0x0004) [0x0000000000000000]              
};
...
struct FChallengeScoreRecord
{
	...
	class ASFXPawn_Player*                             Player;                                           		// 0x0078 (0x0004) [0x0000000000000000]              
};
...
struct FSFXPreAsyncWorkQueuedPowerImpact
{
	...
	unsigned long                                      bReplicateCustomAction : 1;                       		// 0x006C (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bFirstTarget : 1;                                 		// 0x006C (0x0004) [0x0000000000000000] [0x00000004] 
};
